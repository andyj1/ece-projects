...
unsigned int hashTable::getPrime(int size)	{
	...
	int primes[] = {29671, 49157, 98317, 196613, 393241, 786433, 1572869, 3145739, 6291469, 1258917, 25165843, 50331653, 100663319, 201326611, 402653189, 805306457, 1610612741};
